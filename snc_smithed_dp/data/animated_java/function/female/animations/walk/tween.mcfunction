...
tag @s add animated_java.female.animation.walk.playing
...
execute at @s run function animated_java:female/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:female/animations/walk/zzz/apply_frame {frame: $(to_frame)}
