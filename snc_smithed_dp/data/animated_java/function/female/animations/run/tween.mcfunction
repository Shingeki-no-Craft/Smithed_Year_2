...
tag @s add animated_java.female.animation.run.playing
...
execute at @s run function animated_java:female/animations/run/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:female/animations/run/zzz/apply_frame {frame: $(to_frame)}
