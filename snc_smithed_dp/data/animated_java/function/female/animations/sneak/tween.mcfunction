...
tag @s add animated_java.female.animation.sneak.playing
...
execute at @s run function animated_java:female/animations/sneak/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:female/animations/sneak/zzz/apply_frame {frame: $(to_frame)}
