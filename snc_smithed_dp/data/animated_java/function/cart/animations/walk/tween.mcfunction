...
tag @s add animated_java.cart.animation.walk.playing
...
execute at @s run function animated_java:cart/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function animated_java:cart/animations/walk/zzz/apply_frame {frame: $(to_frame)}
