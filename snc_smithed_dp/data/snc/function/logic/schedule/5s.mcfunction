...
execute if score count female_vars matches 2.. as @n[type=#snc:eldian, scores={female_vars=1},tag=!snc.titan,sort=arbitrary] run function snc:shifters/transfer/cheat with storage snc:female