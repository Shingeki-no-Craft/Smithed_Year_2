...
execute if items entity @s weapon.offhand warped_fungus_on_a_stick[item_model="snc:gear/gear",custom_data~{out:1b}] run return 1
item modify entity @s weapon.offhand snc:gear/unsheath
item modify entity @s weapon.mainhand snc:gas_trigger/unsheath
