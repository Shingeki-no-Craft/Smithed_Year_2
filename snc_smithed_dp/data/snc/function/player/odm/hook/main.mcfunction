...
## Land
$execute unless score $(name) snc.odm_state matches 0 if entity @s[tag=!snc.wire.shifter] positioned ~-3.5 ~-3.5 ~-3.5 if entity @n[type=#snc:titan, dx=6,dy=6,dz=6,tag=snc.hook.titan] run function snc:player/odm/hook/land_shifter {"name":"$(name)"}
