...
$execute positioned ~-4.5 ~-4.5 ~-4.5 as @e[type=player,tag=snc.titan,dx=8,dy=8,dz=8] run damage @s 1 arrow by $(name)
...
ride @s mount @n[type=#snc:titan, tag=snc.hook.titan]
