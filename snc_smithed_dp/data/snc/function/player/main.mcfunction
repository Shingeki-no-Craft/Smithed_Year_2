...
execute unless entity @s[tag=summit.battlegrounds.player] positioned -70 60 122 unless entity @s[dz=-38,dx=70,dy=36] if predicate snc:odm/has_gas_trigger if predicate snc:odm/has_odm run return 0
