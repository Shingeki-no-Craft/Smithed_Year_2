...
execute unless entity @s[tag=summit.battlegrounds.player] positioned -70 60 122 unless predicate summit.booth:snc/in_booth if predicate snc:odm/has_gas_trigger if predicate snc:odm/has_odm run return 0
