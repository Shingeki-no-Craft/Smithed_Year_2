...
execute if score @s snc.transform matches 300 run playsound minecraft:snc.heart master @s ~ ~ ~ 1 1
...
execute if score @s snc.transform matches 289 run playsound minecraft:snc.heart master @s ~ ~ ~ 1 1
...
execute if score @s snc.transform matches 280 run playsound minecraft:snc.heart master @s ~ ~ ~ 1 1
...
execute if score @s snc.transform matches 273 run playsound minecraft:snc.heart master @s ~ ~ ~ 1 1.15
...
execute if score @s snc.transform matches 266 run playsound minecraft:snc.heart master @s ~ ~ ~ 1 1.2
