...
execute if score @s snc.transform matches 300 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1
...
execute if score @s snc.transform matches 289 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1
...
execute if score @s snc.transform matches 280 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1
...
execute if score @s snc.transform matches 273 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1.15
...
execute if score @s snc.transform matches 266 run playsound minecraft:entity.warden.heartbeat master @s ~ ~ ~ 1 1.2
...
execute if score @s snc.transform matches 265 run playsound minecraft:snc.shifters.trigger master @a ~ ~ ~ 10 1
