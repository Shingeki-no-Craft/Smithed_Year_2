kill @e[type=mannequin, tag=snc.entity.cart_titan_caller]
kill @e[type=text_display, tag=snc.entity.cart_titan_caller.text]
kill @e[type=interaction, tag=snc.interaction.cart_titan_caller]
