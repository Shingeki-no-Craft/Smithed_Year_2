...
summon mannequin -27.5 64 95.5 {UUID: [-430280407,123948004,-1301470473,-2116288187], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.npc", "snc.entity.cart_titan_caller"],immovable:1b, hide_description:1b, profile:{name:"Bombface68", model:slim}, Invulnerable:1b}
