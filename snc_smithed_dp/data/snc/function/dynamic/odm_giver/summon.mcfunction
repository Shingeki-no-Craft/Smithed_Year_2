...
item replace entity @n[type=mannequin, tag=snc.entity.odm_giver] armor.chest with iron_chestplate[minecraft:equippable={slot: "chest", asset_id: "snc:scout"}]
item replace entity @n[type=mannequin, tag=snc.entity.odm_giver] armor.legs with iron_leggings[minecraft:equippable={slot: "legs", asset_id: "snc:scout"}]
item replace entity @n[type=mannequin, tag=snc.entity.odm_giver] armor.feet with iron_boots[minecraft:equippable={slot: "feet", asset_id: "snc:scout"}]

execute as @n[type=mannequin, tag=snc.entity.odm_giver] run function snc:api/item_replace/military/scouts/odm/gear {"slot": "weapon.offhand", "count": 1}
item modify entity @n[type=mannequin, tag=snc.entity.odm_giver] weapon.offhand snc:gear/store
