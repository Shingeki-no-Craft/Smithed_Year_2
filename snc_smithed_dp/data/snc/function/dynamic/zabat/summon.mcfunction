function snc:dynamic/zabat/kill

#Mannequin
#UUID: 7dbe6c10-a52a-480d-936c-005a61626174
summon mannequin -39.5 87 115.5 {UUID: [2109631504,-1523955699,-1821638566,1633837428], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.npc", "snc.entity.zabat"],immovable:1b, hide_description:1b, profile:{name:"zabatZabat", model:slim}, Invulnerable:1b, attributes:[{id:"scale", base:.9}]}

#Text Display
#UUID: 1c9ab409-a824-4354-a40e-005a61626174
summon minecraft:text_display -39.5 88.9 115.5 {UUID: [479900681,-1474018476,-1542586278,1633837428], Tags:["summit.static", "summit.booth_entity.snc", "snc.entity.zabat.text"], alignment: "center", background: 1073741824, billboard: "center", default_background: 0b, line_width: 200, see_through: 0b, shadow: 0b, text: [{"text":"Zabat","color":"light_purple"},{"text":"\n[NPC]","color":"yellow"}], text_opacity: -1b}
