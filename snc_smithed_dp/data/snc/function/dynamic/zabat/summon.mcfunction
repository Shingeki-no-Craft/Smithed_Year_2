...
summon mannequin -39.5 87 115.5 {UUID: [2109631504,-1523955699,-1821638566,1633837428], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.npc", "snc.entity.zabat"],immovable:1b, hide_description:1b, profile:{name:"zabatZabat", model:slim}, Invulnerable:1b}
