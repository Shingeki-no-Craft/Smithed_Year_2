...
## Arrival
execute if score @s snc.elevator matches 90 if entity @s[tag=snc.elevator.1] run function snc:dynamic/elevator/title {"text": "Crystal Cave", "color": "#0ED7E2", id: "1"}
execute if score @s snc.elevator matches 90 if entity @s[tag=snc.elevator.2] run function snc:dynamic/elevator/title {"text": "Crystal Cave", "color": "#0ED7E2", id: "2"}
execute if score @s snc.elevator matches 90 if entity @s[tag=snc.elevator.3] run function snc:dynamic/elevator/title {"text": "The Mines", "color": "#A67610", id: "3"}
execute if score @s snc.elevator matches 90 if entity @s[tag=snc.elevator.4] run function snc:dynamic/elevator/title {"text": "The Mines", "color": "#A67610", id: "4"}
