...
execute if score @s snc.quest.battlegrounds matches 4 run function snc:dynamic/dialog_box {name:["",{text:"Allawie",color:light_purple},"        "], line_1:["",[{text:"Whichever player enters the "},{text:"arena", color:dark_red}," first will claim"],"           "], line_2: ["",[{text:"the "},{text:"Female Titan",color:dark_purple}," transformation!"],"                    "], line_3:["",[""],"                                                          "], sound:"entity.villager.ambient master @s ~ ~ ~ 3 1"}
