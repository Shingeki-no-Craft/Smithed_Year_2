...
summon mannequin -69.5 72 108.5 {UUID: [1734829927,1734829927,1734829927,1734829927], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.entity.allawie"],immovable:1b, hide_description:1b, profile:{name:"Allawie", model:wide}, Invulnerable:1b}
