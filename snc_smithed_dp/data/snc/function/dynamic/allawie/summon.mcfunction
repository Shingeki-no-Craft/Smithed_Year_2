...
summon mannequin -67.5 72 107.5 {UUID: [1734829927,1734829927,1734829927,1734829927], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.entity.allawie"],immovable:1b, hide_description:1b, profile:{name:"Allawie", model:wide}, Invulnerable:1b}
...
summon interaction -67.5 72 107.5 {UUID: [2004318071,2004318071,2004318071,2004318071], Tags:["summit.static", "summit.booth_entity.snc", "snc.interaction.allawie"], height: 1.875f, response: true}