...
execute if score @s snc.quest.get_odm matches 1 unless score @s snc.quest.odmtrack matches 1 if score @s snc.quest.odmtrack.progress matches 1..4 run function snc:dynamic/dialog_box {name:{text:"TL. Skull",color:green}, line_1:{"text":"You're not ready yet!"}, line_2:{"text":""}, line_3:{text:""}, sound:"entity.villager.ambient master @s ~ ~ ~ 1 1"}

# Have ODM Gear + Just Finished Track Quest
execute if score @s snc.quest.get_odm matches 1 unless score @s snc.quest.odmtrack matches 1 if score @s snc.quest.odmtrack.progress matches 5 run function snc:dynamic/dialog_box {name:{text:"TL. Skull",color:green}, line_1:["Soldier...", {"text":" You have completed ", color:"dark_green"}, "the track!"], line_2:["Wear this ", {"text":"badge", color:dark_purple}, " with pride for your success. You seem"], line_3:[{text:"skilled... Why not head at the"},{"text":" battlegrounds ","color":"dark_red"},"now?"], sound:"entity.villager.ambient master @s ~ ~ ~ 1 1"}
