...
execute if entity @s[advancements={snc:odm_get=true}] unless score @s snc.quest.odmtrack matches 1 if score @s snc.quest.odmtrack.progress matches 6 run return run function snc:dynamic/odmtrack_completer/finish
