...
summon mannequin -60.5 80 111.5 {UUID: [-338313220,502809701,-1592019307,1562684737], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.entity.odm_suggester"],immovable:1b, hide_description:1b, profile:{name:"TakezoS", model:slim}, Invulnerable:1b}
