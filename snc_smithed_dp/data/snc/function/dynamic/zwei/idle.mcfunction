...
execute if entity @s[scores={snc.animation_idle.zwei=1..}] run scoreboard players remove @s snc.animation_idle.zwei 1
execute if entity @s[scores={snc.animation_idle.zwei=0}] run scoreboard players reset @s snc.animation_idle.zwei
