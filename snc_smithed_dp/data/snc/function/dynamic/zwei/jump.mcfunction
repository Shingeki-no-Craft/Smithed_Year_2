...
execute if score @s snc.animation_jump.zwei matches 20 at @s run data modify entity @s item.components.minecraft:item_model set value "titan/zwei/attack/1"
execute if score @s snc.animation_jump.zwei matches 17 at @s run tp @s ^ ^0.6 ^-1.4
execute if score @s snc.animation_jump.zwei matches 17 at @s run data modify entity @s item.components.minecraft:item_model set value "titan/zwei/attack/2"
execute if score @s snc.animation_jump.zwei matches 14 at @s run tp @s ^ ^0.3 ^-1.4
execute if score @s snc.animation_jump.zwei matches 14 at @s run data modify entity @s item.components.minecraft:item_model set value "titan/zwei/attack/3"
execute if score @s snc.animation_jump.zwei matches 11 at @s run tp @s ^ ^-0.3 ^-0.9
execute if score @s snc.animation_jump.zwei matches 11 at @s run data modify entity @s item.components.minecraft:item_model set value "titan/zwei/attack/4"
execute if score @s snc.animation_jump.zwei matches 8 at @s run tp @s ^ ^-0.6 ^-0.5
execute if score @s snc.animation_jump.zwei matches 8 at @s run data modify entity @s item.components.minecraft:item_model set value "titan/zwei/attack/5"
execute if score @s snc.animation_jump.zwei matches 4 at @s run tp @s ^ ^-0.4 ^-0.5
execute if score @s snc.animation_jump.zwei matches 4 at @s run data modify entity @s item.components.minecraft:item_model set value "titan/zwei/attack/6"
