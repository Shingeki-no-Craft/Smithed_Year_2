...
summon mannequin -31.5 87 107.5 {UUID: [983322129,-2107805425,-1821638542,1634168417], Tags:["summit.dynamic", "summit.booth_entity.snc", "snc.npc", "snc.entity.ragnaar"],immovable:1b, hide_description:1b, profile:{name:"B6_C", model:wide}, Invulnerable:1b}
...
summon minecraft:text_display -31.5 89.0625 107.5 {UUID: [495666222,997739560,-1480523662,1634168417], Tags:["summit.static", "summit.booth_entity.snc", "snc.entity.ragnaar.text"], alignment: "center", background: 1073741824, billboard: "center", default_background: 0b, line_width: 200, see_through: 0b, shadow: 0b, text: [{"text":"Gen. Ragnaar","color":"dark_green"},{"text":"\n[NPC]","color":"yellow"}], text_opacity: -1b}

#Interaction
#UUID: be3a22e9-34af-4bbe-9d44-007261676e61
summon interaction -31.5 87 107.5 {UUID: [-1103486231,883903422,-1656487822,1634168417], Tags:["summit.static", "summit.booth_entity.snc", "snc.interaction.ragnaar"], height: 1.875f, response: true}
