...
execute if score $jump_tick snc.cart matches 1 run function animated_java:cart/animations/jump_start/stop
execute if score $jump_tick snc.cart matches 1 run function animated_java:cart/animations/jump_mid/play
...
execute if score $jump_tick snc.cart matches 16 run teleport @s -32.5 65.0 100.5

# End Loop
execute if score $jump_tick snc.cart matches 16.. run function animated_java:cart/animations/jump_mid/stop
execute if score $jump_tick snc.cart matches 16.. run function animated_java:cart/animations/jump_end/play
