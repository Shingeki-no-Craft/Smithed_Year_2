...
execute positioned -52.5 65.0 108.5 facing -33 64 108 run function animated_java:cart/summon {args: {animation:idle, start_animation: true}}
...
ride 6a75984c-ec7a-48ae-a6a1-f28d27033215 mount 1751e58c-0f26-4ef5-bf2f-0556b7f66581

#UUID: ce0e4805-ce45-4659-b52e-f829826811cd
execute positioned -52.5 65.0 108 run summon interaction ~ ~ ~ {UUID: [-837924859,-834320807,-1255213015,-2107108915], Tags:["summit.dynamic","summit.booth_entity.snc","snc.interaction.cart_titan"], width: 5.1875f, height: 2.8125f}
ride ce0e4805-ce45-4659-b52e-f829826811cd mount 1751e58c-0f26-4ef5-bf2f-0556b7f66581