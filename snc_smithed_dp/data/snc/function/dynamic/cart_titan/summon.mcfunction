...
execute as @n[tag=animated_java.cart.root] on passengers run data merge entity @s {teleport_duration:40}
...
ride @n[tag=snc.entity.cart_ghast] mount @n[tag=animated_java.cart.root]
...
ride @n[tag=snc.interaction.cart_titan] mount @n[tag=animated_java.cart.root]