...
execute if score $riders.check snc.cart matches 1.. as 6a75984c-ec7a-48ae-a6a1-f28d27033215 on passengers run title @s actionbar {"text":"CHOMP!", "color":"light_purple"}
