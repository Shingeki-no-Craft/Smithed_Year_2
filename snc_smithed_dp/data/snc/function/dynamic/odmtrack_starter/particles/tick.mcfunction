...
execute positioned -9 73 113 as @s[dx=1, dy=1, dz=1] if score @s snc.quest.odmtrack.progress matches 1 run function snc:dynamic/odmtrack_starter/particles/point
...
execute positioned -25.0 73.5 110.0 as @s[dx=1, dy=1, dz=1] if score @s snc.quest.odmtrack.progress matches 2 run function snc:dynamic/odmtrack_starter/particles/point
...
execute positioned -19.5 73 95.5 as @s[dx=1, dy=1, dz=1] if score @s snc.quest.odmtrack.progress matches 4 run function snc:dynamic/odmtrack_starter/particles/point
...
execute positioned -9.5 72.1 93.5 as @s[dx=1, dy=1, dz=1] if score @s snc.quest.odmtrack.progress matches 5 run function snc:dynamic/odmtrack_starter/particles/point
