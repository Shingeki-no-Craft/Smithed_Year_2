...
execute if score @s snc.quest.get_odm matches 1 run scoreboard players reset @s snc.wait.odmtrack
execute if score @s snc.quest.get_odm matches 1 run function snc:dynamic/odmtrack_starter/start_quest
