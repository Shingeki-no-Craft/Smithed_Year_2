...
execute if score @s snc.quest.get_odm matches 1 if score @s snc.quest.odmtrack matches 1 run function snc:dynamic/dialog_box {name:{text:"Gen. Hope",color:green}, line_1:{"text":"You are welcome to train here at any given moment."}, line_2:{text:""}, line_3:{text:""}, sound:"entity.villager.ambient master @s ~ ~ ~ 1 2"}
