...
# Don't have ODM Gear
execute if entity @s[advancements={snc:odm_get=true}] unless score @s snc.quest.odmtrack matches 1 run scoreboard players reset @s snc.wait.odmtrack
execute if entity @s[advancements={snc:odm_get=true}] unless score @s snc.quest.odmtrack matches 1 if function snc:dynamic/odmtrack_starter/start_quest run return -1
