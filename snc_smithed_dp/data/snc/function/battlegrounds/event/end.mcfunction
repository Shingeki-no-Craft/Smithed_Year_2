...
# Titan won
execute if score $win snc.battlegrounds matches 1.. if entity @s[team=snc.battlegrounds.female] run return run function snc:battlegrounds/event/end/titan_win
