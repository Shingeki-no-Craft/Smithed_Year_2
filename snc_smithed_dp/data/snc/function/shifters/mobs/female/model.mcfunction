...
execute if score state female_vars matches 5 if entity @s[tag=!aj.female.animation.run.playing] run function snc:shifters/mobs/female/animate/run
execute if score state female_vars matches 6 if entity @s[tag=aj.female.animation.jump_loop.playing] if score $air female_vars matches 0 run function snc:shifters/mobs/female/animate/jump_end
