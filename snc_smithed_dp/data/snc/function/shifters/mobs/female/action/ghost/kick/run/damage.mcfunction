$execute on vehicle on passengers if entity @s[tag=snc.titan] if score $set_hardening female_vars matches 0 positioned ~ ~-2 ~ on vehicle rotated as @s rotated ~ 0 positioned ^ ^ ^2 run function snc:shifters/combat/damage {"distance":8,"half_distance":4,"shifter":"female","sound":"aot.punch","damage":$(damage_ghost_retribution),"extra_damage":0,"knockback":$(knockback_ghost_retribution),"energy":$(energy_ghost),"angle":$(angle_ghost)}
$execute on vehicle on passengers if entity @s[tag=snc.titan] if score $set_hardening female_vars matches 1 positioned ~ ~-2 ~ on vehicle rotated as @s rotated ~ 0 positioned ^ ^ ^2 run function snc:shifters/combat/damage {"distance":8,"half_distance":4,"shifter":"female","sound":"aot.punch","damage":$(damage_ghost_retribution),"extra_damage":$(hardening_damage),"knockback":$(knockback_ghost_retribution),"energy":$(energy_ghost),"angle":$(angle_ghost)}
