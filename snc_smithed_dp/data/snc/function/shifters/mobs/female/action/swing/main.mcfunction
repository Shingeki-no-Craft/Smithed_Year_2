...
execute positioned ~-4.5 ~-4.5 ~-4.5 as @e[dx=8,dy=8,dz=8,type=!#snc:pivot,predicate=!snc:shifters/female/score] unless score @s shifter_vars matches 4 run function snc:shifters/mobs/female/action/swing/damage with storage snc:female
