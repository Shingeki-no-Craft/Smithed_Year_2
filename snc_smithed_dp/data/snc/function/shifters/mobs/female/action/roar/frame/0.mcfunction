...
execute on vehicle on passengers if entity @s[tag=snc.titan] on vehicle at @s rotated ~ -2 run function snc:logic/motion/generic {"score":"female_vars","strength":0.025, "unstoppable":"false"}
