function animated_java:female/animations/berserk_leap_l/play
...
execute on vehicle at @s rotated ~-5.625 0 run function snc:logic/motion/generic {"score":"female_vars","strength":0.02, "unstoppable":"false"}
return 1