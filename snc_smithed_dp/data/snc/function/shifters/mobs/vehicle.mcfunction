...
# Health System
$bossbar set snc:$(shifter)_health players @a[tag=summit.battlegrounds.player]
...
$execute on passengers if entity @s[tag=snc.titan] on vehicle run scoreboard players set @s $(shifter)_vars 20
