...
$execute if score #posx1 $(shifter)_vars matches ..-1 run scoreboard players operation #posx1 $(shifter)_vars *= #-1 snc.constant
...
$execute if score #posz1 $(shifter)_vars matches ..-1 run scoreboard players operation #posz1 $(shifter)_vars *= #-1 snc.constant
# Save the current position to #posx0
