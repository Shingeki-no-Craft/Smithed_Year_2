...
execute if entity @s[tag=snc.titan] run return -1
...
function snc:shifters/function/unique {"pre":"function snc:shifters/human/bite/shifter with storage snc:","post":""}
